...
h1 = plot(eddyScaleReducedGCM_earthLike(:,1),eddyScaleFullGCM_earthLike(:,1),'--bo',...
    'linewidth',1,'markeredgecolor','b','MarkerFaceColor','b',...
    'markersize',markersize1);
hold on
h2 = plot(eddyScaleReducedGCM_earthLike(:,2),eddyScaleFullGCM_earthLike(:,2),'--rs',...
    'linewidth',1,'markeredgecolor','r','MarkerFaceColor','r',...
    'markersize',markersize1);
h3 = plot(eddyScaleReducedGCM_earthLike(:,3),eddyScaleFullGCM_earthLike(:,3),'--m^',...
    'linewidth',1,'markeredgecolor','m','MarkerFaceColor','m',...
    'markersize',markersize1);
h4 = plot(eddyScaleReducedGCM_earthLike(:,4),eddyScaleFullGCM_earthLike(:,4),'--gd',...
...
set(gca,'XTickLabel',{'','500','','','','','1000','2000','','4000','5,000'},...
    'XTick',[400 500 600 700 800 900 1000 2000 3000 4000 5000],...
    'YTickLabel',{'','500','','','','','1000','2000','','4000','5,000'},...
...
xlabel({'L_e (km), reduced GCM'},'FontSize',fontsize1,'FontWeight','bold');
ylabel({'L_e (km), full GCM'},'FontSize',fontsize1,'FontWeight','bold');
...
h1 = plot(genScaleFull_earthLike(:,1),eddyScaleFullGCM_earthLike(:,1),'--bo',...
    'linewidth',1,'markeredgecolor','b','MarkerFaceColor','b',...
    'markersize',markersize1);
hold on
h2 = plot(genScaleFull_earthLike(:,2),eddyScaleFullGCM_earthLike(:,2),'--rs',...
    'linewidth',1,'markeredgecolor','r','MarkerFaceColor','r',...
    'markersize',markersize1);
h3 = plot(genScaleFull_earthLike(:,3),eddyScaleFullGCM_earthLike(:,3),'--m^',...
    'linewidth',1,'markeredgecolor','m','MarkerFaceColor','m',...
    'markersize',markersize1);
h4 = plot(genScaleFull_earthLike(:,4),eddyScaleFullGCM_earthLike(:,4),'--gd',...
    'linewidth',1,'markeredgecolor','g','MarkerFaceColor','g',...
    'markersize',markersize1);
...
xlabel({'Energy generation scale (km)'},'FontSize',fontsize1,'FontWeight','bold');

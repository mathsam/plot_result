%% plot the ensemble experiments: PhaseShiftHeightRatio_orig vs. gamma
% run these first
% expNum = 1; HeightRatio = zeros(6,9);
gamma = [0.1 0.2 0.5 1 2 5 10 20 40];
HeightRatio(expNum,:) = PhaseShiftHeightRatio_fullGCM/PhaseShiftHeightRatio_fullGCM(4);
expNum = expNum+1;
%%
...
ylabel('h_\theta/H, ratio about \gamma=1','fontsize',16)
axis square
xlim([0.1 40])